...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">View Job</h1>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <th>Status</th>
                                        ...
                                        while($row=$result->fetch_assoc())
                                        {
                                           ...
                                           <td>".$row['email']."</td>
                                           <td>".$row['status']."</td>                            
                                           <td> <a href='viewjob.php?apsid=$row[id]' class='btn btn-success'>approve<a>
                                           <a href='viewjob.php?rjsid=$row[id]' class='btn btn-danger'>Reject<a></td>
                                            </tbody>
                                            ";
                                        }
                                        ?>
  ...
  {
    $id=$_GET['apsid'];
    $result = $mysqli->query("UPDATE jobs SET Status= 'open' WHERE id = $id") or die($mysqli->error);
  ...
  {
    $id=$_GET['rjsid'];
    $result = $mysqli->query("UPDATE jobs SET Status= 'closed' WHERE id = $id") or die($mysqli->error);
