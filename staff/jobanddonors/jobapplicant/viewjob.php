...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
           ...
           <h2>How to apply</h2>
           <p>Submit you cover letter and relevant documents to hr@hopecore.org, All the Best!!!!</p>
                    <!-- Page Heading -->
  ...
  {
    $id=$_GET['apsid'];
    $result = $mysqli->query("UPDATE jobs SET Status= 'application_accepted' WHERE id = $id") or die($mysqli->error);
  ...
  {
    $id=$_GET['rjsid'];
    $result = $mysqli->query("UPDATE jobs SET Status= 'application_rejected' WHERE id = $id") or die($mysqli->error);
