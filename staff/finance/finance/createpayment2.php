                        ...
                        <div class="card-body">
                            <div class="table-responsive"  >
                                ...
                                <div class="form-group">
                                  <p> please follow the following <b>instructions <u>carefully</u></b> to proceed:
                               ...
                               <div class="form-group">
                                   <label>Amount Ksh:</label>
                                      ...
                                      <?php 
                                       ...
                                       $result=$mysqli->query("select * from medicalsupplies where id='$apapsid'")or die($mysqli->error);
                                       $drivers_list=array();
