                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered" id="appointment">
                                    ...
                                    <th>Status</th>
                                        ...
                                        FROM appointments  JOIN users ON doctors_email =users.email JOIN patients ON patient_email =patients.email where patient_email='$login_session' ") or die($mysqli->error);
