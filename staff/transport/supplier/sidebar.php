...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="main.php">
    ...
    <div class="sidebar-brand-text mx-3">Supplier's Portal <sup></sup></div>
</a>
...
<li class="nav-item">
    ...
    <div id="treatment" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="viewsupply.php">View Medicalsupply</a>
...
<li class="nav-item">
    ...
    <div id="payments" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="viewpayment.php">My Payments</a>
