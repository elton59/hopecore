...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Pay supplier</h1>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered" id="appointment">
                                    ...
                                    <th>Status</th> 
                                        ...
                                        <?php
                                        $result=$mysqli->query("select medicalsupplies .*,supplier.firstname as sfirstname,supplier.lastname as slastname from medicalsupplies join supplier on supplier.email=medicalsupplies.driver_email where medicalsupplies.status='request_approved'") or die($mysqli->error);
                                        while($row=$result->fetch_assoc())
                                        {
                                           ...
                                           <td>".$row['status']."</td>
                                           <td> <a href='createpayment2.php?apapsid=$row[id]' class='btn btn-success'>pay<a>
                                        </td>
  ...
  ?>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">approved payments</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive"  >
                            <table class="table table-bordered" id="appointment">
