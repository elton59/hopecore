                            ...
                            <table class="table table-bordered" id="appointment">
                                  ...
                                  <th>Stock Quantity</th>
                                    ...
                                    <th>Status</th>
                                        ...
                                        <?php
                                        $result=$mysqli->query("select * from medicalsupplies where category='drugs'") or die($mysqli->error);
                                 ...
                                 <a href="viewdrugreports.php" download button  class="btn btn-success" >Download Report</a></td>
                            </div>
                            <?php
    if(isset($_GET['apsid']))
  {
