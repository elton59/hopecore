...
if(isset($_POST['createfeedback']))
{
    ...
    if($result)
    {
        echo
        "<script>alert('operation successfull');
        window.location.replace('viewfeedback.php')
        </script>
        ";
    }
    else
...
if(isset($_POST['editfeedback']))
{
   ...
   $result=$mysqli->query("UPDATE  feedback SET firstname='$fdfname',lastname='$fdlname',phonenumber='$fdpno',message='$fdmessage',receiver='$fdreceiver',reply='$fdreply',email='$fdemail'where id='$id'") or die($mysqli->error);
...
if(isset($_POST['createjob']))
{
    ...
    if($result)
    {
        echo
        "<script>alert('operation successfull');
        window.location.replace('viewjob.php')
        </script>
        ";
    }
    else
...
if(isset($_POST['editjob']))
{
   ...
   $result=$mysqli->query("UPDATE  jobs SET jobtitle='$jbtitle',description='$jbdes',comment='$jbtarea' where id='$id'") or die($mysqli->error);
