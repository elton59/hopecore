...
<body id="page-top">
 ...
 <td>" . $row['nchv_comment'] . "</td>
                                           <td>" . $row['status'] . "</td>
                                           <td> <a href='viewtreatment.php?dapapsid=$row[id]' class='btn btn-info'> Drug Received<a>
                                           </td>
                                            </tbody>
                                            ";
                                    }
                               ...
                               <a href="vreport.php?apapsid=?apapsid=<?php echo $login_session;?>"  button class="btn btn-success 
                                ">Download</a></td>
                            </div>
                            <?php
