...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">View Payment</h1>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered" id="appointment">
                                    ...
                                    <th>Status</th>
                                        ...
                                        <?php
                                        $result=$mysqli->query("select * from payments where useremail='$login_session'") or die($mysqli->error);
  ...
  {
    $id=$_GET['apsid'];
    $result = $mysqli->query("UPDATE payments SET Status= 'approved' WHERE id = $id") or die($mysqli->error);
  ...
  {
    $id=$_GET['rjsid'];
    $result = $mysqli->query("UPDATE payments SET Status= 'rejected' WHERE id = $id") or die($mysqli->error);
