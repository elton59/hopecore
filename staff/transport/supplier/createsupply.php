                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive"  >
                               ...
                               $uid=$row['id'];
                                                          $result2=$mysqli->query("select * from medicalsupplies order by id desc")or die($mysqli->error); 
                              $row2=$result2->fetch_assoc();
                               $qty=$row2['stockbalance'];
                               $stock=$row2['stock_in_out'];
                                ...
                                <div class="form-group">
                                        <input class="form-control" name="supcomp" placeholder="Input Company" required/>
                               </div>
                               <div class="form-group">
                               ...
                               <div class="form-group">
                               <p>Input Expiry Date</p>
                                        <input class="form-control" type="datetime-local" name="supexdate" placeholder="Expiry Date" required/>
                               </div>
                               <div class="form-group">
                                        <input class="form-control" type="number" name="supweight" placeholder="Input weight (IN KGS)" required/>
                               </div>
                               <p>Assign Hope core Driver</p>
                               <div class="form-group">
                                   <select name="supdemail" class="form-control">
                                      
                                           <?php 
                                            $result=$mysqli->query("select * from users where specialization='driver'")or die($mysqli->error);
                                            $drivers_list=array();
                               ...
                               <div class="form-group">
                                        <input class="form-control" type="number" name="supsin" placeholder="Input Stock in/out" required max="<?echo $stock?>>"/>
                               </div>
                               <div class="form-group">
                                        <input class="form-control"  type="hidden" name="supsqty" placeholder="quantity" value="<?php echo $qty?>" required/>
                               </div>
